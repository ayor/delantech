        ...
        <div className="col-md-6 col-sm-6">
          ...
          <ul className="list-inline">
            <li className="list-inline-item">
              <Link href="https://www.facebook.com/Delantech/" passHref>
                <span>
            ...
            <li className="list-inline-item">
              <Link href="https://twitter.com/Delantech_" passHref>
                <span>
                  <a target="_blank" rel="noreferrer">
            ...
            <li className="list-inline-item">
              <Link href="https://www.instagram.com/delantech/" passHref>
                <span>
                  <a target="_blank" rel="noreferrer">
