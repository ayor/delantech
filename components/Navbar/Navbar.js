...
const Navbar = ({ showBackground, page }) => {
  ...
  return (
    <div className="container">
      <nav
        className={
          'navbar navbar-expand-sm navbar-light fixed-top p-3 ' +
          NavStyles.NavBar
        }
      >
        <Link href="/" passHref>
            ...
            <ul className="navbar-nav mr-auto ">
              <li className="nav-item mr-2">
                <Link href="/">
                  <a className="nav-link ">
                    {' '}
                    <span className={page === 'Home' ? NavStyles.Active : ''}>
                      Home
                    </span>
                  </a>
                </Link>
              ...
              <li className="nav-item mr-2">
                <Link href="/#product">
                  <a className="nav-link">
                    {' '}
                    <span className={page === 'prod' ? NavStyles.Active : ''}>
                      Products
                    </span>
                  </a>
                </Link>
              ...
              <li className="nav-item mr-2">
                <Link href="/#services">
                  <a className="nav-link ">
                    {' '}
                    <span className={page === 'serv' ? NavStyles.Active : ''}>
                      Services
                    </span>
                  </a>
                </Link>
            ...
            <div>
              <Link href="/carts" passHref>
                <a className="text-light">
                  ...
                  <span className={' mx-2   ' + NavStyles.Cart}>
                    {cartLength}
                  </span>
                </a>
              </Link>
