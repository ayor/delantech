        ...
        <div className="__container rounded my-2" key={ind}>
            <div style={{
                ...
                <div className="h-100 ">
                    ...
                    <Chip label="Watch A Demo" onClick={handleOpen} variant="contained" icon={<PlayCircleFilledOutlinedIcon />} />
                </div>
                <Modal open={open} onClose={handleClose}
                    ...
                    <div className="embed-responsive embed-responsive-16by9 " style={{
                        ...
                        <iframe className="embed-responsive-item mr-2" src={item.youtubeUrl} style={{ width: '100%', height: '400px' }} frameBorder="0" allowFullScreen></iframe>
                    </div>
                </Modal>
            </div>
        </div>))
